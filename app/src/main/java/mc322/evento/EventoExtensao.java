 ...
 * 
 * <p>É uma subclasse de {@link CaracteristicaEvento}, sendo usada para marcar
...
public class EventoExtensao extends CaracteristicaEvento {
     ...
     * @param publicoAlvo        grupo de pessoas para o qual a atividade é destinada.
     * @param valeHoras          se {@code true}, a atividade conta como horas de extensão.
     * @param cargaHoraria       quantidade de horas atribuídas à atividade (se valer horas).
     */
    ...
    /**
     * Retorna uma descrição formatada da atividade de extensão, incluindo o público-alvo
