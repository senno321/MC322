...
/**
 * Representa uma reunião como característica de um evento, incluindo participantes,
 * objetivo e o modo de realização (online ou presencial).
 * 
 * <p>Essa classe é uma subclasse de {@link CaracteristicaEvento} e é usada
...
public class EventoReuniao extends CaracteristicaEvento {
     ...
     * @param online        {@code true} se a reunião for online; {@code false} se for presencial.
     */
    ...
    /**
     * Retorna uma descrição resumida da reunião, incluindo participantes, objetivo e modo.
     * 
