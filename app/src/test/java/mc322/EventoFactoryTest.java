...
class EventoFactoryTest {
    ...
    void testCriarEventoReuniao() {
        Evento evento = EventoFactory.criarEventoReuniao("Alinhamento", "Online", "12/07/2025", "14:00", 45, "Time A", "Definir metas", true);
    ...
    void testCriarEventoExtensao() {
        Evento evento = EventoFactory.criarEventoExtensao("Palestra", "Auditório", "18/07/2025", "19:00", 90, "IA no mercado", "Estudantes", true, 2);
